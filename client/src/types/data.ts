import { Deadline, Reminder } from "./deadlines";
...
export interface DataContextType {
    ...
    addDeadline: (deadline: Omit<Deadline, 'id' | 'userId' | 'createdAt'>) => Promise<{ deadline: Deadline }>;
    updateDeadline: (id: string, updates: Partial<Deadline>) => Promise<{ deadline: Deadline }>;
    deleteDeadline: (id: string) => Promise<{ success: boolean }>;
    markAsComplete: (id: string) => Promise<{ success: boolean }>;
