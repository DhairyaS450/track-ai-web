...
async function processChatMessage(message, user, context) {
  ...
  The current time and date is ${format(new Date(), "yyyy-MM-dd'T'HH:mm")}. Make sure to take this into account when suggesting times for events and deadlines or giving any recommendations.
