...
console.log('CORS middleware configured with:', {
  origin: process.env.NODE_ENV === 'production'
    ? [process.env.CLIENT_URL, 'https://tidaltasks.app', 'https://www.tidaltasks.app']
    : 'http://localhost:5173',
  credentials: true,
});
app.use(cors({
...
app.options('*', (req, res) => {
  ...
  if (process.env.NODE_ENV === 'production') {
    if (origin === process.env.CLIENT_URL || origin === 'https://tidaltasks.app' || origin === 'https://www.tidaltasks.app') {
